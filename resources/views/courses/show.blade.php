    ...
    <section class="bg-gray-700 py-12 mb-12">
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="text-white">
                ...
                <p><i class="far fa-star"></i>Calificion: {{$course->rating}}</p>
            </div>
        </div>
    </section>
    ...
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            <section class="bg-white shadow-lg rounded overflow-hidden mb-12">
                <div class="px-6 py-4">
                    <h1 class="text-gray-900 font-bold text-2xl mb-2">Lo que aprenderás</h1>
            ...
            <section class="mb-12">
                <h1 class="text-gray-900 font-fold text-3xl mb-2">Temario</h1>
            ...
            <section class="mb-8">
                <h1 class="text-gray-900 font-bold text-3xl">Requisitos</h1>
            ...
            <section>
                <h1 class="text-gray-900 font-bold text-3xl">Descripción</h1>
            ...
            <section class="bg-white shadow-lg rounded overflow-hidden mb-4">
                <div class="px-6 py-4">
                    ...
                    @can('enrolled', $course)
                        ...
                        <a class="font-bold py-2 px-4 rounded bg-red-500 text-white block text-center mt-4" href="{{route('course.status', $course)}}">Continuar con el curso</a>
                ...
                @foreach ($similares as $similar)
                    <article class="flex mb-6">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-gray-900"><i class="fas fa-star mr-2 text-yellow-400"></i>{{$similar->rating}}</p>
